		...
		<section id="app-section">
			...
			<div class="bg-white padding margin-top-lg">
				<div class="app-page-header">
					<h4>पहिलो चौमासिक लक्ष्य</h4>
					
				</div>
				<form>
					<div class="form-group">
						<label>कार्यक्रम (१.)</label>
					</div>
					<div class="form-group">
						<label for="input1">परिमाण</label>
						<input type="text" class="form-control" id="input1" placeholder="10">
					</div>
					<div class="form-group">
						<label for="input2">भार</label>
						<input type="text" class="form-control" id="input2" placeholder="5">
					</div>
					<div class="form-group">
						<label for="input3">लागत</label>
						<input type="text" class="form-control" id="input3" placeholder="150,000">
					</div>
